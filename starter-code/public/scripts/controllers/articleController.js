...
(function(module) {
  ...
  //This function is calling the articles data to define the view we will see. It uses the articleView.index function located in the articleView.js file.
  ...
  articleController.loadById = (ctx, next) => {
    ...
    // COMMENT: What is this function doing? Where is it called? Does it call any other functions, and if so, in what file(s) do those function(s) live?
    // This function is finding the articles by ID. There is no other functions called in the function.
